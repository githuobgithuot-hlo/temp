        ...
        for match in matched_events:
            ...
            if total_prob < 1.0:
                ...
                if profit_pct >= self.min_arbitrage_profit:
                    # Determine opposite team for arbitrage display
                    opposite_team = team2 if arb_team == team1 else team1
                    ...
                    opportunity = {
                        ...
                        'platform_b': 'cloudbet',
                        'team': arb_team,
                        'opposite_team': opposite_team,  # Add opposite team for display
                        ...
                        'cb_teams': cb_teams  # Add teams tuple for reference
                    }
